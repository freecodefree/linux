...
int make_dgram_server_socket(int portnum){
	...
	if(make_internet_address(hostname,portnum,&saddr)==-1)return -1;
...
// get_internet_address,host,len,portp,addrp,strncpy,inet_ntoa,ntohs,
// make_dgram_client_socket,
// make_dgram_server_socket,portnum,PF_INET,SOCK_DGRAM,
// make_internet_address,hostname,port,sockaddr_in,addrp,hostent,htons
